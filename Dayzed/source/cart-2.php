          ...
          <div class="basket basket--cart">
            <ul class="basket__list">
              <li class="basket__item">
                ...
                <div class="basket__right">
                  ...
                  <p>Total: <span class="basket__price">17.98</span>$</p>
                </div>
              </li>
              <li class="basket__item">
                <div class="basket__left">
                  <a class="button" href="/">
                    <picture class="basket__picture picture">
                      ...
                      <img width="63" height="84" src="img/basket-2.png" alt="img">
                    </picture>
                  </a>

                  <div class="basket__text">
                    <h3 class="basket__title">
                      CBD GUMMIES WITH TURMERIC & SPIRULINA 40MG (8CT POUCH) FULL SPECTRUM
                    </h3>
                ...
                <div class="basket__right">
                  ...
                  <p>Total: <span class="basket__price">4.5</span>$</p>
                </div>
              </li>
            </ul>
            <div class="basket__bottom">
              ...
              <p class="basket__button-wrapper basket__button-wrapper--promocod">
                ...
                <a class="basket__link button-yellow button" href="checkout.php">Proceed to checkout</a>
              </p>
            </div>
          </div>
        </div>
