    ...
    <main class="page-main">
      <section class="banner">
        <div class="banner__wrapper">
          <picture class="picture">
            <source srcset="img/banner--paso.webp" type="image/webp">
            <img width="1139" height="209" src="img/banner--paso.jpg" alt="img">
          </picture>
        </div>
      </section>
      ...
      <section class="pagination">
        <div class="pagination__wrapper">
          <h1 class="pagination__title">Paso</h1>
          ...
          <ul class="pagination__list">
            ...
            <li>
              <a href="paso.php">Paso</a>
            </li>
          </ul>
        </div>
      </section>

      <section class="categories categories--paso">
        <h2 class="visually-hidden">List of Paso</h2>
        <div class="categories__wrapper">
          <p class="categories__description categories__description--paso">
          ...
          <ul class="paso products-list">
            <?php $i = 1; ?>
            <?php while ($i < 9) : ?>

              <li class="paso__item products-list__item">
                <a class="paso__link products-list__link button" href="/product-<?= $i ?>.php">
                  <picture class="paso__picture products-list__picture picture">
                    <source srcset="img/product-<?= $i ?>.webp" type="image/webp">

                    <img width="281" height="188" src="img/product-<?= $i ?>.png" alt="img">
                  </picture>

                  <h3 class="paso__title products-list__title">CBD CHARCOAL FACE MASK BROAD SPECTRUM</h3>

                  <p class="paso__rating products-list__rating rating">
                ...
                <p class="paso__price products-list__price ">
                  <span>6.99</span>$
                </p>

                <button class="paso__cart products-list__cart button button-yellow" type="button" name="add-to-cart" data-product="<?= $i ?>">Add to cart</button>
              </li>
            <?php $i++; ?>
            <?php endwhile; ?>
          </ul>
